...
namespace Proyect.Presentation.Controllers
{
    ...
    public class FacturaComprasController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreateBuyBillForSupplier(Guid proveedorId, [FromBody] FacturaProveedorForCreationDto factCompra)
        {
        ...
        [HttpPut("{id:guid}")]
        public IActionResult UpdateBuyBillForSupplier(Guid proveedorId, Guid id, [FromBody] FacturaProveedorForUpdateDto factCompra)
        {
            if (factCompra is null)
            {
        ...
        public IActionResult PartiallyUpdateFacturaCompraForProveedor(Guid proveedorId, Guid id,
            [FromBody] JsonPatchDocument<FacturaProveedorForUpdateDto> patchDoc)
        {
            if (patchDoc is null)
