...
namespace Proyect.Presentation.Controllers
{
    ...
    public class FacturaVentasController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult CreateSaleBillForUser(Guid usuarioId, [FromBody] FacturaForCreationDto saleBill)
        {
            if (saleBill is null)
            {
        ...
        [HttpPut("{id:guid}")]
        public IActionResult UpdateSaleBillForUser(Guid usuarioId, Guid id, [FromBody] FacturaForUpdateDto saleBill)
        {
            if (saleBill is null)
            {
        ...
        public IActionResult PartiallyUpdateFacturaVentaForUsuario(Guid usuarioId, Guid id,
            [FromBody] JsonPatchDocument<FacturaForUpdateDto> patchDoc)
        {
            if (patchDoc is null)
